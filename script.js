...
const translations = {
  ...
  ca: {
    ...
    document_title: "Manel Gil Sorribes | AI Senior Project Manager",
    meta_description:
      "Portafolis de Manel Gil Sorribes, AI Senior Project Manager i professor de machine learning especialitzat en descobriment computacional de fàrmacs, predicció d'interaccions biomoleculars, genòmica i programari científic.",
    og_title: "Manel Gil Sorribes | AI Senior Project Manager en descobriment computacional de fàrmacs",
    og_description:
      "AI Senior Project Manager i professor de machine learning que construeix sistemes de deep learning per a la predicció d'interaccions proteïna-lligand, genòmica i ciència intensiva en dades.",
    ...
    hero_eyebrow: "AI Senior Project Manager - Professor d'aprenentatge automàtic - Físic",
    hero_title: "Liderant IA per al descobriment biomolecular.",
    hero_lede:
      "Lidero i construeixo sistemes d'aprenentatge automàtic per al descobriment computacional de fàrmacs, la predicció d'interaccions proteïna-lligand, la classificació de seqüències genòmiques i fluxos de treball científics intensius en dades.",
    ...
    stat_teaching_value: "Professor d'aprenentatge automàtic al màster de la UPC",
    stat_base_label: "Ubicació",
    stat_base_value: "Barcelona, Espanya",
    portrait_alt: "Retrat de Manel Gil Sorribes",
    signal: "Treballo on conflueixen el lideratge en IA, les dades moleculars, la biologia i el programari científic desplegable.",
    about_eyebrow: "Sobre mi",
    about_title: "Un enginyer de recerca amb l'instint d'un físic per als models.",
    about_p1:
      "Soc AI Senior Project Manager amb experiència en transformers, fine-tuning de models i IA generativa. A Nostrum Biodiscovery gestiono, desenvolupo i optimitzo models de deep learning per al descobriment computacional de fàrmacs, coordinant enginyers d'IA, científics, parts interessades i comunicació tècnica amb clients.",
    about_p2:
      "La meva trajectòria combina física, sistemes interactius intel·ligents, recerca en genòmica, enginyeria de dades en producció i docència en laboratoris d'aprenentatge automàtic al Master in Data Science de la UPC. Aquesta combinació m'ajuda a passar de la pregunta científica al flux de dades, l'arquitectura del model, l'avaluació, la comunicació i el lliurament pràctic.",
    experience_eyebrow: "Experiència",
    experience_title: "Liderant IA aplicada en recerca, lliurament i docència.",
    date_dec2025_present: "Des. 2025 - Actualitat",
    exp_senior_title: "AI Senior Project Manager",
    exp_senior_li1: "Lideratge de projectes d'IA i ciència aplicada en descobriment computacional de fàrmacs.",
    exp_senior_li2:
      "Gestió d'equips transversals d'enginyers d'IA, científics i parts interessades per lliurar solucions preparades per a producció.",
    exp_senior_li3:
      "Punt de contacte amb clients, amb supervisió de la comunicació tècnica, el seguiment de progrés i l'alineament de requisits.",
    ...
    upc_name: "Universitat Politècnica de Catalunya",
    exp_upc_title: "Professor d'aprenentatge automàtic al màster - a temps parcial",
    exp_upc_li1: "Docència de sessions de laboratori de l'assignatura de Machine Learning al Master in Data Science.",
    exp_upc_li2: "Cobertura de tècniques fonamentals d'aprenentatge automàtic i implementacions pràctiques guiades.",
    ...
    exp_genomics_li2:
      "Treball amb conjunts de dades biològiques a gran escala, incloent preprocessament, extracció de característiques i optimització de models.",
    ...
    exp_cap_title: "Business Intelligence Consultant - Data Engineer",
    exp_cap_li1: "Treball en integració, transformació i automatització de dades amb PL/SQL, Informatica PowerCenter i SAP.",
    ...
    research_eyebrow: "Línies de recerca",
    research_title: "Sistemes d'IA per a dades moleculars i seqüències biològiques.",
    focus1_title: "Lideratge en descobriment computacional de fàrmacs",
    focus1_text:
      "Lideratge de projectes d'IA aplicada que connecten requisits científics, desenvolupament de models, alineament amb parts interessades i lliurament en producció.",
    focus2_title: "Predicció d'interaccions proteïna-lligand",
    focus2_text: "Fluxos de treball de deep learning per modelitzar interaccions biomoleculars i donar suport al descobriment computacional de fàrmacs.",
    focus3_title: "Transformers i IA generativa",
    focus3_text: "Modelització basada en transformers, eines amb LLMs, fine-tuning i mètodes generatius per a problemes científics amb dades.",
    focus4_title: "Classificació de seqüències genòmiques",
    focus4_text: "Pipelines de machine learning per a dades de seqüència biològica, des del preprocessament i l'extracció de característiques fins a l'avaluació de models.",
    focus5_title: "Docència en aprenentatge automàtic",
    focus5_text: "Docència de laboratoris sobre tècniques fonamentals d'aprenentatge automàtic i implementacions pràctiques en un programa de màster en ciència de dades.",
    pubs_eyebrow: "Publicacions",
    pubs_title: "Articles i treballs de congrés seleccionats.",
    pub1_tag: "Workshops GEM i LMRL d'ICLR - 2025",
    pub1_text: "Treball de workshop presentat a ICLR 2025 a Singapur.",
    pub2_tag: "Journal of Cheminformatics - 2026",
    pub2_text:
      "Article d'accés obert sobre línies base simples i interpretables amb fingerprints moleculars per a la predicció DDI i DDA.",
    journal_article: "Article de revista",
    pub3_tag: "Workshops LMRL i AI4NA d'ICLR - 2025",
    pub3_text: "Treball de workshop presentat a ICLR 2025 a Singapur.",
    pub4_tag: "Journal of Data-centric Machine Learning Research - 2025",
    pub4_text: "Article de DMLR que introdueix un marc de codi obert per al benchmarking de topological deep learning.",
    pub5_tag: "Workshop GRaM d'ICML - 2024",
    pub5_text: "Treball de workshop d'ICML 2024 a Viena.",
    pub6_tag: "HCist Conference - 2023",
    pub6_text: "Publicat i presentat a la conferència HCist.",
    work_eyebrow: "Treball seleccionat",
    work_title: "Treball professional orientat a la utilitat científica.",
    work1_tag: "Descobriment computacional de fàrmacs",
    work1_title: "Lideratge de projectes d'IA",
    work1_text: "Lideratge de projectes de ciència aplicada, coordinació d'equips, alineament de requisits i comunicació del progrés tècnic amb clients.",
    ...
    work3_title: "Laboratoris d'aprenentatge automàtic",
    work3_text: "Docència a temps parcial al Master in Data Science de la UPC, centrada en tècniques fonamentals d'aprenentatge automàtic i implementacions pràctiques.",
    ...
    skills_title: "Eines per connectar models, dades i lliurament.",
    skill1_title: "Machine Learning",
    ...
    skill4_title: "Cloud i programari",
    skill4_text: "GCP, AWS, Salesforce Sales Cloud, Informatica Cloud, Microsoft Office, LaTeX",
    skill5_title: "Idiomes",
    skill5_text: "Castellà i català nadius, anglès fluid amb certificat B2, italià inicial",
